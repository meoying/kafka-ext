...
-- 测试时间范围分库分表
CREATE TABLE IF NOT EXISTS kafka_ext.delay_msgs_tab_0 LIKE kafka_ext.delay_msgs;
CREATE TABLE IF NOT EXISTS kafka_ext.delay_msgs_tab_1 LIKE kafka_ext.delay_msgs;
CREATE TABLE IF NOT EXISTS kafka_ext.delay_msgs_tab_2 LIKE kafka_ext.delay_msgs;